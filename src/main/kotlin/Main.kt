...
const val CATEGORY = 678
const val COLLECTION = "ios-jobs"
const val POSITION_NAME = "iOS 개발자"
...
val ENV_KEY_DISCORD_WEBHOOKS = arrayOf("DISCORD_WEBHOOK", "DISCORD_IOS_WEBHOOK")
