...
const val CATEGORY = 895
const val COLLECTION = "node-jobs"
const val POSITION_NAME = "노드 개발자"
...
val ENV_KEY_DISCORD_WEBHOOKS = arrayOf("DISCORD_WEBHOOK", "DISCORD_NODE_WEBHOOK")
